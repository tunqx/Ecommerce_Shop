...
<tr class="success">
  ...
  for($i=0;$i<=(int)$_SESSION["intLine"];$i++)
  {
	  ...
	  {
		$strSQL = "SELECT * FROM Product3 WHERE Productid = '".$_SESSION["strProductID"][$i]."' ";
	  ...
	  <tr>
		...
		<td><a href="delete_wallet.php?Line=<?php echo $i;?>">x</a></td>
	  </tr>
	  <?php
	  }
  }
...
<br><br><a href="wallet.php">Go to Product</a>
<?php
	if($SumTotal > 0)
	{
?>
