...
<tr class="success">
  ...
  for($i=0;$i<=(int)$_SESSION["intLine"];$i++)
  {
	  ...
	  {
		$strSQL = "SELECT * FROM Product2 WHERE Productid = '".$_SESSION["strProductID"][$i]."' ";
	  ...
	  <tr>
		...
		<td><a href="delete_mailbag.php?Line=<?php echo $i;?>">x</a></td>
	  </tr>
	  <?php
	  }
  }
...
<br><br><a href="mailbag.php">Go to Product</a>
<?php
	if($SumTotal > 0)
	{
?>
