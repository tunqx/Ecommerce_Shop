...
<table width="900"  border="1">
  ...
  <tr>
    ...
    <td><center><a href="order_mailbag.php?ProductID=<?php echo $objResult["Productid"];?>">Order</a></td>
...
<br><br><a href="show_mailbag.php">View Cart</a> | <a href="clear_mailbag.php">Clear Cart</a>
<?php
mysqli_close($con);
?>
    </center>
