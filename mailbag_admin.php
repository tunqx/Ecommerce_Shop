...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
   ...
   <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <a href="bagpack_admin.php" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i>Bagpack</a>
    <a href="mailbag_admin.php" class="w3-bar-item w3-button"><i class="fa fa-caret-right w3-margin-right"></i>Mailbag</a>
    <a href="wallet_admin.php" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i>Wallet</a>
    <a href="admin_page.php" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i>Back_admin</a>
...
?></i>
  ...
  <div class="w3-container w3-text-grey" id="mailbag">
    <p><b>Bag Pack</b></p>
    <p>8 items</p>
	<?php
...
<table width="900"  border="1">
  ...
  <tr>
	...
	<td><center><img style="width:200px;height:200px" src="<?php echo $objResult["img"];?>"></td>
    <td><center><?php echo $objResult["Productid"];?></td>
    <td><center><?php echo $objResult["Productname"];?></td>
    <td><center><?php echo $objResult["Price"];?></td>
    <td><center><a href="order.php?ProductID=<?php echo $objResult["Productid"];?>">Order</a></td>
