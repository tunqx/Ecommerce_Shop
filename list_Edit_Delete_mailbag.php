...
?>
  <tr>
	...
	<td align="center"><a href="edit_product_mailbag.php?Productid=<?php echo $result["Productid"];?>">Edit</a></td> 
  <td align="center"><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='delete_product_mailbag.php?Productid=<?php echo $result["Productid"];?>';}">Delete</a></td>
  </tr>
<?php
}
?>
