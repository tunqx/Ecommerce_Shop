...
?>
<table width="900"  border="1" style='table-layout:fixed'>
  <tr>
  ...
  <tr>
    ...
    <td><center><a href="order_bagpack.php?ProductID=<?php echo $objResult["Productid"];?>">Order</a></td>
...
<br><br><a href="show_bagpack.php">View Cart</a> | <a href="clear_bagpack.php">Clear Cart</a>
<?php
mysqli_close($con);
?>
    </center>
