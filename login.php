  ...
  <div class="w3-container w3-display-container w3-padding-16">
   ...
   <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <div id="demoAcc" class="w3-bar-block w3-hide w3-padding-large w3-medium">
      <a href="#bagpack" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i>Bagpack</a>
      <a href="#mailbag" class="w3-bar-item w3-button"><i class="fa fa-caret-right w3-margin-right"></i>Mailbag</a>
      <a href="#wallet" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i>Wallet</a>
