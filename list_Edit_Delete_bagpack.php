...
<?php
	...
	$connnect = mysqli_connect($serverName,$userName,$userPassword,$dbName);
...
<table width="650" border="1">
  <tr>
    ...
    <th width="198"> <div align="center">Qty </div></th>
    <th width="97"> <div align="center">Price </div></th>
	<th width="50"> <div align="center">Edit </div></th>
  <th width="50"> <div align="center">Deletet </div></th>
  </tr>
<?php
...
?>
  <tr>
    ...
    <td><div align="center"><?php echo $result["Price"];?></div></td>
	<td align="center"><a href="edit_product_bagpack.php?Productid=<?php echo $result["Productid"];?>">Edit</a></td> 
  <td align="center"><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='delete_product_bagpack.php?Productid=<?php echo $result["Productid"];?>';}">Delete</a></td>
  </tr>
<?php
}
?>
...
?>
<a href="bagpack_admin.php">View files</a>
<br>
</center>
<!-- Subscribe section -->
